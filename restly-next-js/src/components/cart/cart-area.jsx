        ...
        <div className="container">
          {cartItems.length === 0 &&
            <div className='text-center'>
              ...
              <Link href={'/shop'} className="theme-btn mt-15">
                Return to shop
              </Link>
            </div>
          }
                          ...
                          <div className="product-quantity mt-10 mb-10">
                            <div className="product-quantity-form">
                              <form onSubmit={(e) => e.preventDefault()}>
                                ...
                                <button onClick={() => dispatch(cart_product(item))} className="cart-plus">
                ...
                <div className="col-12">
                  <div className="coupon-all">
                    <div className="coupon d-sm-flex align-items-center">
                      ...
                      <button className="theme-btn" name="apply_coupon" type="submit">Apply
                        coupon</button>
                    </div>
                    <div className="coupon2">
                      <button onClick={() => dispatch(clear_cart())} className="theme-btn" 
